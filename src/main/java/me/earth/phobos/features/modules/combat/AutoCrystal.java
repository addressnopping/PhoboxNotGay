...
public class AutoCrystal
    ...
    public AutoCrystal() {
        super("AutoCrystal", "calvice insanamente skidada do oyvey", Module.Category.COMBAT, true, false, false);
    }
    ...
    public void onCrystal() {
        ...
        if (this.placeTimer.passedMs(this.placeDelay.getValue().longValue()) && this.place.getValue().booleanValue()) {
            ...
            else if (this.hotBarSlot != -1 && this.autoswitch.getValue().booleanValue() && !AutoCrystal.mc.player.isPotionActive(MobEffects.WEAKNESS) && this.silent.getValue().booleanValue() == false) {
