...
//porfa funciona :weary: eu so quero uma hud boa aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
...
public class HUD extends Module {
    ...
    private final Setting<String> spoofGreeter = register(new Setting("GreeterName", "peter da dev", v -> greeter.getValue() == Greeter.CUSTOM));
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        switch (watermark.getValue()) {
            case PHOBOX:
                renderer.drawString("PhoboX" + (modeVer.getValue() ? " v" + Phobos.MODVER : ""), 2, 2, color, true);
                break;
            case NOTGAY:
                renderer.drawString("PhoboxNotGay" + (modeVer.getValue() ? " v" + Phobos.MODVER : ""), 2, 2, color, true);
            default:
        }
    ...
    public void renderGreeter() {
        ...
        switch (greeter.getValue()) {
            case TIME:
                ...
                break;
            case LONG:
                text += "Welcome to PhoboX " + mc.player.getDisplayNameString() + " >:)";
                break;
            case ULTRALONG:
                text += "Welcome to PhoboxNotGay " + mc.player.getDisplayNameString() + " >:)";
                break;
            case CUSTOM:
