...
public class HUD
    ...
    private final Setting<String> customWatermark = this.register(new Setting<String>("WatermarkName", "eeeee"));
    ...
    private final Setting<String> spoofGreeter = this.register(new Setting<Object>("GreeterName", "idk", v -> this.greeter.getValue() == Greeter.CUSTOM));
    ...
    public void onRender2D(final Render2DEvent event) {
        ...
        switch (this.watermark.getValue()) {
            ...
            case CUSTOM: {
                this.renderer.drawString(this.customWatermark.getValue() + (this.modeVer.getValue() ? " v1.1" : ""), 2.0f, 2.0f, (this.rolling.getValue() && this.rainbow.getValue()) ? this.colorMap.get(2) : this.color, true);
                break;
            }
        }
    ...
    public void renderGreeter() {
        ...
        switch (this.greeter.getValue()) {
            ...
            case LONG: {
                text = text + "Welcome to PhoboX " + HUD.mc.player.getDisplayNameString() + " :^)";
                break;
            }
            case ULTRALONG: {
                text = text + "Welcome to PhoboxNotGay " + HUD.mc.player.getDisplayNameString() + " :^)";
                break;
            }
            case CUSTOM: {
